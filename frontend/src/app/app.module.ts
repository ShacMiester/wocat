...
import { AuthInterceptor } from "../app/authServices/auth.interceptor";
@NgModule({
  providers: [ExportdataComponent, LoginComponent, {provide: HTTP_INTERCEPTORS,useClass: AuthInterceptor, multi: true}],
  declarations: [
    AppComponent,
    FiltersComponent,
    DashboardComponent,
